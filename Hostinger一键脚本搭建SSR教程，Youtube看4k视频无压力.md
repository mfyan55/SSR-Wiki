...
BBR 是 Google 的一款 SSR 加速产品，使用下面的命令就可以实现 BBR 加速，只有 [Hostinger](https://www.hostg.xyz/aff_c?offer_id=6&aff_id=18493&aff_sub=GitHub&url_id=39) 等少数 KVM VPS 才支持 BBR 加速，这也是我们推荐选择 Hostinger 的原因。
